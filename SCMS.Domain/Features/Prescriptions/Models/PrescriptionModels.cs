...
namespace SCMS.Domain.Features.Prescriptions.Models
{
    ...
    public sealed record PrescriptionItemDto
    {
        ...
        public string? DoseTime { get; init; } // morning / afternoon / evening / night / bedtime / custom
        public decimal DoseQuantity { get; init; } = 1.0m;
        public string? DoseUnit { get; init; } // tablet / capsule / ml / drop / puff / injection
        public string? MealTiming { get; init; } // before_meal / after_meal / with_meal / anytime
        public string? Route { get; init; } // oral / topical / injection / eye_drop / ear_drop / inhalation
    ...
    /// <summary>Prescription details response.</summary>
    ...
    /// <summary>Prescription template response.</summary>
